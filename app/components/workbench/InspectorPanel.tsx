...
export const InspectorPanel = ({ selectedElement, isVisible, onClose }: InspectorPanelProps) => {
  ...
  return (
    <div className="fixed end-4 top-20 w-80 bg-bolt-elements-bg-depth-1 border border-bolt-elements-borderColor rounded-lg shadow-lg z-40 max-h-[calc(100vh-6rem)] overflow-hidden">
      {/* Header */}
