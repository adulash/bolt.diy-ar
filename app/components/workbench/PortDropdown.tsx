  ...
  ({
    ...
    return (
      <div className="relative z-port-dropdown" ref={dropdownRef}>
        ...
        {isDropdownOpen && (
          <div className="absolute start-0 mt-2 bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor rounded shadow-sm min-w-[140px] dropdown-animation">
