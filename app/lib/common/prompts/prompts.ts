...
<language>
  Reply in the same language the user writes in. If the user writes in Arabic, respond in Modern Standard Arabic. Keep code, file paths, shell commands, identifiers, and technical terms in their original form (Latin script); only translate prose, explanations, and user-facing messages.
</language>
